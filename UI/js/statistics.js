...
truePosData.data = [ 4,1,2];  //4 are classified as positive, 1 is classified as neural, 2 are classified as negative. 
trueSentiData.push(truePosData);

var trueNeuData = new Object();
trueNeuData.name = "True Neutral";
trueNeuData.data = [ 1,8,2];  //1 are classified as positive, 4 is classified as neural, 2 are classified as negative. 
trueSentiData.push(trueNeuData);

var trueNegData = new Object();
trueNegData.name = "True Negative";
trueNegData.data = [ 2,3,8];  //2 are classified as positive, 3 is classified as neural, 8 are classified as negative. 
